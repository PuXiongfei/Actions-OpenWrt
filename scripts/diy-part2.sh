...
ls package | grep *argon*

echo "增加 jerrykuku/luci-app-argon-config"
git clone --depth=1 https://github.com/jerrykuku/luci-app-argon-config package/luci-app-argon-config
ls package | grep *argon-config*

echo "增加 xiaorouji/openwrt-passwall"
git clone --depth 1 https://github.com/xiaorouji/openwrt-passwall package/openwrt-passwall
ls package | grep *passwall*

echo "增加 vernesong/luci-app-openclash"
git clone --depth 1 https://github.com/vernesong/OpenClash package/OpenClash
ls package | grep *openclash*

echo "增加 Lienol/luci-app-socat"
git clone --depth 1 https://github.com/Lienol/openwrt-package Lienol/openwrt-package
ls -1 Lienol/openwrt-package | grep *socat*
cp -af Lienol/openwrt-package/luci-app-socat package
ls package | grep *socat*
...
if [ "$CONFIG_FILE_DEVICE" = "D2" ]; then
    ...
    sed -n '/d-team_newifi-d2$/,/d-team_newifi-d2$/p' target/linux/ramips/image/mt7621.mk
    echo "修改passwall默认值"
    sed -i '/"Include Haproxy"/,/^config/{s/arm/arm||mips||mipsel/g}' package/lean/luci-app-passwall/Makefile
    sed -i '/"Include V2ray"/,/^config/{s/arm/arm||mips||mipsel/g}' package/lean/luci-app-passwall/Makefile
    sed -i '/"Include V2ray-Plugin/,/^config/{s/arm/arm||mips||mipsel/g}' package/lean/luci-app-passwall/Makefile
    sed -i '/"Include Xray"/,/^endmenu/{s/arm/arm||mips||mipsel/g}' package/lean/luci-app-passwall/Makefile
